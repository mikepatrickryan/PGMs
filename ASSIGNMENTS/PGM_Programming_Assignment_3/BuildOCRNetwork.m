...
if (~isempty(pairwiseModel))
    %%% MIKE RYAN
    % After testing ComputeEqualPairwiseFactors,comment out that line and
    % uncomment the normal ComputePairwiseFactors function
    %%%
...
if (isfield(imageModel, 'ignoreSimilarity') && imageModel.ignoreSimilarity)
    ...
    %%%% MIKE RYAN
    % Currently ChooseTopSimilarityFactors does NO selection
    %%%%%%%%%%%%%%
