...
%
% Each variable will have a number.  We need a consistent way of
...
for i=1:numPeople, 
	...
	if (0==sum(parent)),
		...
		factorList(i) = genotypeGivenParentsGenotypesFactor(numAlleles, i, parent(1,1), parent(1,2));
	end;
end;

%populate the phenotype factors 
for j=numPeople+1:2*numPeople,
	genotypeVar = j-numPeople;
	factorList(j) = phenotypeGivenGenotypeFactor(alphaList, genotypeVar, j);
end;
end	
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Variable numbers:
